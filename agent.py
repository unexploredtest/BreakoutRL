...
class Agent:
    def __init__(self, model, device="cpu", epsilon=1.0, min_epsilon=0.1, nb_warmups=10000,
        ...
        self.epsilon_decay = 1 - (((epsilon - min_epsilon) / nb_warmups) * 2)
        ...
        self.optim = optim.Adam(model.parameters(), lr=learning_rate)
